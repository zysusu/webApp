        ...
        <header class="head-nav">
            <el-row>
                <el-col :span="18" class='logo-container'>
                    <img src="../../../assets/top_logoandname.png" style="height:100px;" class='logo' alt="">
                </el-col>
                <el-col :span="6" class="userinfo" style="margin-left: -40px;">
                    <!-- <span class='username'><i class='fa fa-user'></i>{{this.$store.state.user.userinfo.username}}</span> -->
                    <span class='userName' style="font-size: 18px; line-height: 130px;"><i class='fa fa-user'></i>欢迎您，{{userName}}</span>
                  <!--   <span class='username'>
                        <el-dropdown
                                trigger="click"
                    ...
                    <i class="fa fa-sign-out logout" @click='logout'>注销</i>
                </el-col>
            </el-row>
        </header>
